...
@Mod.EventBusSubscriber(modid = BetterWithSpartanry.MODID)
public class ModelRenderRegistryBWSpartanry {

    private static List<ModelRegistryEntry> models = new ArrayList();

    public ModelRenderRegistryBWSpartanry() {
    }
    ...
    public static void registerItemRenders(ModelRegistryEvent ev) {
        ...
        while(var1.hasNext()) {
            ...
            registerItemRender(entry.getItem(), BetterWithSpartanry.MODID + ":" + entry.getModelLocation());
        }
        models.clear();
    }
